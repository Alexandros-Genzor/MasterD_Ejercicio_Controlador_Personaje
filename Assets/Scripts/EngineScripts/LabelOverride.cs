...
public class LabelOverride : PropertyAttribute
{
    ...
    /// <summary>
    /// Replaces the serialized variable name (either public or private with [SerializeField] with a customizable one. in the inspector<p/>
    ...
    /// </summary>
    /// <param name="label">The label text / name. </param>
